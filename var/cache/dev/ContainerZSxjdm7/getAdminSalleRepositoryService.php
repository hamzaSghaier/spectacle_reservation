...
// Returns the private 'App\Repository\AdminSalleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/AdminSalleRepository.php';

return $this->privates['App\\Repository\\AdminSalleRepository'] = new \App\Repository\AdminSalleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
