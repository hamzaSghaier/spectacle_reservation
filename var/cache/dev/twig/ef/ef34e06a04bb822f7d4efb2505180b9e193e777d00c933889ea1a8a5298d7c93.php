...
class __TwigTemplate_ec7e0c9702473abf9149b53ba67e03b57807eb746c518c7851fefea0d591e166 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<label<?php if (\$label_attr) { echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$label_attr]); } ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$label, \$label_translation_parameters, \$translation_domain) : \$label) ?></label>
<?php endif ?>
", "@Framework/Form/form_label.html.php", "/home/monta/Documents/ApplicationSymfony/spectacle_reservation/vendor/symfony/framework-bundle/Resources/views/Form/form_label.html.php");
    }
}
